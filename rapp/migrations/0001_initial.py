# Generated by Django 2.1 on 2018-08-18 09:10
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(db_column='ID', primary_key=True, serialize=False)),
                ('tf', models.CharField(db_column='TF', max_length=150, verbose_name='TF')),
                ('tf_beschreibung', models.CharField(blank=True, db_column='TF Beschreibung', max_length=150, null=True, verbose_name='TF-Beschreibung')),
                ('enthalten_in_af', models.CharField(blank=True, db_column='Enthalten in AF', max_length=150, null=True, verbose_name='AF')),
                ('tf_kritikalitaet', models.CharField(blank=True, db_column='TF Kritikalität', max_length=150, null=True, verbose_name='TF-Kritikalität')),
                ('tf_eigentuemer_org', models.CharField(blank=True, db_column='TF Eigentümer Org', max_length=150, null=True, verbose_name='TF-Eigentümer-orga')),
                ('gf', models.CharField(blank=True, db_column='GF', max_length=150, null=True, verbose_name='GF')),
                ('vip_kennzeichen', models.CharField(blank=True, db_column='VIP Kennzeichen', max_length=150, null=True, verbose_name='VIP')),
                ...
                ('af_zuweisungsdatum', models.DateTimeField(blank=True, db_column='AF Zuweisungsdatum', null=True, verbose_name='AF Zuweisung')),
                ...
                ('geaendert', models.IntegerField(blank=True, db_column='geändert', null=True, verbose_name='AF geändert')),
                ...
                ('loeschdatum', models.DateTimeField(blank=True, db_column='löschdatum', null=True, verbose_name='Löschdatum')),
            ],
            options={
                'db_table': 'tblGesamt',
