# Generated by Django 2.1 on 2018-08-25 21:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('definition_field', models.CharField(blank=True, db_column='definition', max_length=250, null=True)),
                ('verantwortlicher_field', models.CharField(blank=True, db_column='verantwortlicher', max_length=150, null=True)),
                ('telefon_verantwortlicher_field', models.CharField(blank=True, db_column='telefon', max_length=150, null=True)),
                ('user_id_verantwortlicher_field', models.CharField(blank=True, db_column='userid', max_length=50, null=True)),
                ('fk_field', models.CharField(blank=True, db_column='fk', max_length=250, null=True)),
            ],
            options={
